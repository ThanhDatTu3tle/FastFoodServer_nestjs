...
var AddressService = /** @class */ (function () {
    function AddressService(addressRepository, customerRepository) {
        this.addressRepository = addressRepository;
        this.customerRepository = customerRepository;
    }
    AddressService.prototype.create = function (createAddressDto) {
        return __awaiter(this, void 0, Promise, function () {
            var customerBody, customer, newAddress, findAndReturn, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.addressRepository.findOneOrFail({
                                relations: relations_1.AddressRelations,
    ...
    AddressService = __decorate([
        common_1.Injectable(),
        __param(0, typeorm_1.InjectRepository(Danhsachdiachi_1.Danhsachdiachi)),
