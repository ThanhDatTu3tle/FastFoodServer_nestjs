...
var FavoriteService = /** @class */ (function () {
    function FavoriteService(favoriteRepository, customerRepository, productRepository) {
        this.favoriteRepository = favoriteRepository;
        this.customerRepository = customerRepository;
        this.productRepository = productRepository;
    }
    FavoriteService.prototype.create = function (createFavoriteDto) {
        return __awaiter(this, void 0, Promise, function () {
            var customerBody, customers, productBody, products, newFavorite, findAndReturn, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        customers = _a.sent();
                        productBody = createFavoriteDto.maMonAn;
                        return [4 /*yield*/, this.productRepository.findOneByOrFail({
                                maMonAn: productBody
                            })];
                    case 2:
                        products = _a.sent();
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.favoriteRepository.findOneOrFail({
                                relations: relations_1.FavoriteRelations,
                                where: {
    ...
    FavoriteService.prototype.findAll = function () {
        return "This action returns all favorite";
    };
    FavoriteService = __decorate([
        common_1.Injectable(),
        __param(0, typeorm_1.InjectRepository(Monanyeuthich_1.Monanyeuthich)),
        __param(1, typeorm_1.InjectRepository(Khachhang_1.Khachhang)),
        __param(2, typeorm_1.InjectRepository(Monan_1.Monan))
    ], FavoriteService);
